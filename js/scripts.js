...
function setupEventListeners() {
    ...
    document.addEventListener('click', (e) => {
        if (!cartOverlay.contains(e.target) && e.target.className !== 'cart-icon' && !e.target.closest('.cart-icon')) {
